	...
	<section class="box">
		...
		<div class="box filterbox">
			<div class="box_content clearfix toggle_container">
				<p>You can't recover "Contribution" once deleted, are you sure to delete? <a class="edit" href="<?php echo $delete_link; ?>">Yes</a> / <a class="edit" href="<?php echo generateUrl('blogcontributions'); ?>">Cancel</a></p>
			</div>
		</div>
	</section>
</section>