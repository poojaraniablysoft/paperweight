...
<section class="rightPanel wide">
	<ul class="breadcrumb">
		...
		<li>Total Money Earning</li>
	</ul>
	<?php echo Message::getHtml(); ?>
	<div class="title"><h2>Total Money Earning : <span><?php if($total_earned >= 0) {echo CONF_CURRENCY . $total_earned;}else {echo "-". CONF_CURRENCY . abs($total_earned);}?></span></h2></div>
	...
	<section class="box" id="commission">
					...
					foreach ($arr_flds as $key=>$val){
						...
						switch ($key){
							...
							case 'writer_name':
								...
								break;
							case 'me_cust_trans' : 
								$td->appendElement('plaintext', array(), $row['me_cust_trans'],true);
								break;
							case 'me_writer_recv' :
								$td->appendElement('plaintext', array(), $row['me_writer_recv'],true);
								break;
							case 'system_amount':
	...
	<section class="box" id="transaction">
