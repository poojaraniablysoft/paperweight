...
<section class="rightPanel wide">
	<ul class="breadcrumb">
		...
		<li>Total Money Credit - 24 Hrs</li>
	</ul>
	<?php echo Message::getHtml(); ?>
	<div class="title"><h2>Total Money Credit - 24 Hrs : <span><?php echo CONF_CURRENCY.$today_credit;?></span></h2></div>
					...
					foreach ($arr_flds as $key=>$val){
						...
						switch ($key){
							...
							case 'user_screen_name':
								...
								break;
							case 'wtrx_comments':
								$td->appendElement('plaintext', array(), ($row['wtrx_comments'] != '') ? $row['wtrx_comments'] : 'No Comments!', true);
								break;								
							case 'wtrx_amount':
