...
<section class="rightPanel wide">
	<ul class="breadcrumb">
		...
		<li>Total Money Paid</li>
	</ul>
	<?php echo Message::getHtml(); ?>
	<div class="title"><h2>Total Money Paid : <span><?php echo CONF_CURRENCY.$total_paid;?></span></h2></div>
					...
					foreach ($arr_flds as $key=>$val){
						...
						switch ($key){
							...
							case 'task_ref_id':
								...
								break;
							case 'customer_name':
								$td->appendElement('a', array('href'=>generateUrl('user','preview_customer_profile',array($row['user_id']))), $row['customer_name'], true);
								break;
							case 'writer_name':
								$td->appendElement('a', array('href'=>generateUrl('user','preview_writer_profile',array($row['user_id']))), $row['writer_name'], true);
								break;	
							case 'user_name':
