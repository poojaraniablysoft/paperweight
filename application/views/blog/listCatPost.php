...
defined('SYSTEM_INIT') or die('Invalid Usage');
	...
	if(!$records || !is_array($records)){ echo '<div class="no_result"><div class="no_result_icon"><img src="'.$logoUrl.'"></div><div class="no_result_text"><h5>No Blog Post found!!</h5></p></div></div>'; }else{
...
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-557198d76d84bd2f"></script>