...
<head>
<meta charset="utf-8">
<title><?php echo Utilities::getLabel( 'L_403_Page_Title' ); ?></title>
...
<?php
	$fav_icon = generateUrl('image', 'fav_icon', array( CONF_WEBSITE_FOOTER_LOGO ));
?>
...
<div class="container">
  <div class="row">
    ...
    <div class="span8">
      <h1><?php echo Utilities::getLabel( 'L_403' ); ?></h1>
      <h2><?php echo Utilities::getLabel( 'L_403_Page_Description' ); ?></h2>
      <p>
