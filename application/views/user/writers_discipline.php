	...
	<div class="row whiteBg paddng strip">
		<div class="fix-container">
			...
			<div class="fliter-order">
					...
					<li><a><?php echo Utilities::getLabel( 'L_In' ); ?><i class="icon ion-chevron-down"></i></a>
						...
						<div class="sub-menu">
							<ul>
								...
								<li><a href="<?php echo generateUrl('writers-discipline');?>"><b><?php echo Utilities::getLabel( 'L_All_Disciplines' ); ?></b></a></li>
								...
								<li><a href="<?php echo generateUrl('writers-discipline',seoUrl($val));?>"><?php echo $val;?></a></li>
								<?php } ?>
							</ul>
						</div>
				...
				<form name="frmSearch">
				<input type="hidden" id="discipline_id" name="discipline_id" value="<?php echo $discipline_id; ?>"/>
				</form>			
			<div id="top_writers">
					...
					<?php }
						...
						<div class="grid_1">
							<div class="no_result">
								...
								<p><?php echo Utilities::getLabel( 'L_Try_to_search_with_other_filters' ); ?>. <a href="<?php echo generateUrl('writers-discipline');?>"><?php echo Utilities::getLabel( 'L_Back' ); ?></a> </p>
								</div>
							</div>
						</div>						
						<?php
