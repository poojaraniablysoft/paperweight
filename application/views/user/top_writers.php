					...
					<li><a><?php echo Utilities::getLabel( 'L_In' ); ?><i class="icon ion-chevron-down"></i></a>
						...
						<div class="sub-menu">
							<ul>
								...
								<li><a href="<?php echo generateUrl('top-writers');?>"><b><?php echo Utilities::getLabel( 'L_All_Paper_Type' ); ?></b></a></li>
								...
								<li><a href="<?php echo generateUrl('top-writers',seoUrl($val));?>"><?php echo $val;?></a></li>
								<?php } ?>
							</ul>
						</div>
					...
					<?php }
						...
						<div class="grid_1">
							<div class="no_result">
								...
								<p><?php echo Utilities::getLabel( 'L_Try_to_search_with_other_filters' ); ?>. <a href="<?php echo generateUrl('top-writers');?>"><?php echo Utilities::getLabel( 'L_Back' ); ?></a> </p>
								</div>
							</div>
						</div>						
						<?php
